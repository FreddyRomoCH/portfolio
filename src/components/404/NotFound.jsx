export function NotFound() {
  return (
    <section className="md:col-span-9 md:text-center px-4 lg:px-10 flex flex-col items-center justify-center gap-4 h-dvh">
      ...
      <p className="mb-4 text-neutral-50 font-sans text-md font-light max-w-2xl text-center">
