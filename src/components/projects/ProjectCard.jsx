export function ProjectCard({ title, description, image, url }) {
  return (
    <div className="bg-secondary900 rounded-lg flex flex-col p-6 gap-4 items-center justify-between w-screen md:w-auto">
      <picture>
        <img
      ...
      <h2 className="text-xl lg:text-4xl font-typewriter font-semibold">
        {title}
      </h2>
